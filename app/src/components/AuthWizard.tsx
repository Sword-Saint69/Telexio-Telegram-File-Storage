...
import { ShieldCheck, Sun, Moon, HelpCircle, ExternalLink, X, Minus } from "lucide-react";
...
export function AuthWizard({ onLogin }: { onLogin: () => void }) {
    ...
    return (
        <div 
            ...
            className="h-full w-full auth-gradient flex items-center justify-center p-6 relative overflow-hidden"
        >
            <div className="ambient-blob bg-blue-400 top-[-10%] left-[-10%]" />
            <div className="ambient-blob bg-purple-400 bottom-[-10%] right-[-10%] animation-delay-2000" />
            
            {/* Top Right Controls */}
            <div className="absolute top-4 right-4 flex items-center gap-2 z-50">
                <button
                    onClick={toggleTheme}
                    className="p-2 rounded-md bg-white/5 hover:bg-white/10 transition-colors text-white/70 hover:text-white"
                ...
                <button 
                    ...
                    className="p-2 hover:bg-white/5 rounded-md text-white/70 hover:text-white transition"
                >
                    <Minus className="w-4 h-4" />
                </button>
                <button 
                    onClick={() => appWindow.close()}
                    className="p-2 hover:bg-red-500/20 text-white/70 hover:text-red-400 rounded-md transition"
                >
                    <X className="w-4 h-4" />
                </button>
            </div>
            ...
            <motion.div
                ...
                className="auth-glass p-10 w-full max-w-md relative z-10"
            >
                <div className="text-center mb-10">
                    <img src="/logo.png" alt="Telexio Logo" className="w-24 h-24 mx-auto mb-6 object-contain drop-shadow-2xl" />
                    <h1 className="text-3xl font-display font-bold text-telegram-text mb-2 tracking-tight">Telexio</h1>
                    <p className="text-sm text-telegram-subtext font-medium">Next-Gen Secure Storage</p>
                </div>
                        ...
                        <>
                            ...
                            {step === "setup" && (
                                ...
                                >
                                    <div className="space-y-8 mt-4">
                                        <div className="floating-label-group">
                                            <input
                                                ...
                                                placeholder=" "
                                                className="w-full bg-transparent border-b-2 border-telegram-border/30 py-2 text-telegram-text focus:outline-none focus:border-telegram-primary transition-all font-mono text-base"
                                            />
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-telegram-primary text-white font-semibold py-3.5 rounded-full hover:bg-telegram-primary/90 transition-all shadow-md hover:shadow-lg active:scale-[0.98]"
                                    >
                                        Configure Account
                                    </button>
                                ...
                                >
                                    <div className="floating-label-group">
                                        <input
                                            ...
                                            placeholder=" "
                                            className="w-full bg-transparent border-b-2 border-telegram-border/30 py-3 text-telegram-text focus:outline-none focus:border-telegram-primary transition-all text-xl font-bold tracking-wider"
                                        />
                                    ...
                                    <div className="flex flex-col gap-3">
                                        <button
                                            type="submit"
                                            disabled={loading}
                                            className="w-full bg-telegram-primary text-white font-semibold py-3.5 rounded-full hover:bg-telegram-primary/90 transition-all shadow-md hover:shadow-lg active:scale-[0.98] disabled:opacity-50"
                                        >
                                ...
                                >
                                    <div className="floating-label-group">
                                        <input
                                            ...
                                            placeholder=" "
                                            className="w-full bg-transparent border-b-2 border-telegram-border/30 py-3 text-telegram-text focus:outline-none focus:border-telegram-primary transition-all text-2xl font-bold tracking-[0.5em] text-center pl-[0.5em]"
                                        />
                                        <label htmlFor="code" className="left-0 right-0 mx-auto w-fit text-center">Telegram Code</label>
                                    </div>
                            ...
                            {step === "password" && (
                                ...
                                >
                                    <div className="space-y-6">
                                        <div className="p-4 bg-telegram-primary/5 border border-telegram-primary/10 rounded-xl mb-4">
                                            <p className="text-xs text-telegram-subtext text-center font-medium">
                                                Two-Factor Authentication is active. Please enter your cloud password.
                                            </p>
                                        </div>
                                        <div className="floating-label-group">
                                            <input
                                                ...
                                                placeholder=" "
                                                className="w-full bg-transparent border-b-2 border-telegram-border/30 py-3 text-telegram-text focus:outline-none focus:border-telegram-primary transition-all text-lg font-bold"
                                                autoFocus
                                            />
